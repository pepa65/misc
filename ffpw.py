#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# GPL3+ Based on original work from: www.dumpzilla.org
# Search function in bash:
...
class NSSDecoder(object):
	...
	def find_nss(locations, nssname):
		...
		for loc in locations:
			...
			LOG.error("Couldn't find or load '%s'. This library is essential to interact with your Mozilla profile.", nssname)
			LOG.error("If you are seeing this error please perform a system-wide search for '%s' and file a bug report indicating any location found. Thanks!", nssname)
			LOG.error("Alternatively you can try launching firefox_decrypt from the location where you found '%s'. That is 'cd' or 'chdir' to that location and run firefox_decrypt from there.", nssname)
			LOG.error("Please also include the following on any bug report. Errors seen while searching/loading NSS:")
...
def main():
	...
	if args.export_pass:
		...
		compat = {"username": "username: ", "browserpass": "login: "}
