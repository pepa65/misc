...
alias sc='sed "s/^\(....-..-..T..:..:..\)Z/$(date -d \0+00 +%Y-%m-%dT%H:%M:%S%:::z)/"' # Stalwart log view
...
alias rustfmt='rustfmt --config-path /dev/null'
alias gor='goreleaser release --clean'
alias pop3mail2='curl -u mailsink pop3s://mail2.zwer.men --request'
